...
print("==================== Start face_save.py  ====================")
exec(open("./face_save.py").read())
print("==================== End face_save.py  ====================")
print("||")
print("||")
print("||")
print("==================== Start face_train.py  ====================")
exec(open("./face_train.py").read())
print("==================== End face_train.py  ====================")
print("||")
print("||")
print("||")
print("==================== Start face_detect.py  ====================")
exec(open("./face_detect.py").read())
print("==================== End face_detect.py  ====================")
